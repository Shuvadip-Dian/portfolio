        ...
        <div className="w-full relative pt-8 lg:pt-0" id='about-me'>
            ...
            <div className="flex flex-nowrap md:flex-wrap items-center justify-center w-full">
                <div className="hidden lg:flex items-center justify-center lg:w-[50%]">
                    <Image
                    src={'/Screenshot_20240923_1403456.png'}
                    alt="Web Developer"
                    width={500}
                    height={500}
                    className="p-12"
                ...
                <div className="w-full lg:w-[50%]"> 
                    ...
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Name: </strong><span className="text-gray-200"> Shuvadip Dain</span></p>
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Age: </strong><span className="text-gray-200"> 21 years</span></p>
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Location: </strong><span className="text-gray-200"> Ghatal, West Bengal</span></p>
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Email: </strong><span className="text-gray-200"> shuvadipdian112@gmail.com</span></p>
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Phone: </strong><span className="text-gray-200"> +91 9883320300</span></p>
                </div>
            </div>
        </div>
    );
